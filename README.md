...
2. **`steam_review_counts`** — fetches the Steam summary (`query_summary`: total reviews, score...) of every game that is due: a game is probed nightly while its counters keep moving, then less and less often as it goes quiet.
